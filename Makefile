OBJS = lex.yy.o C.tab.o symbol_table.o nodes.o interpreter.o tac_generator.o main.o
SRCS = lex.yy.c C.tab.c symbol_table.c nodes.c interpreter.c tac_generator.c main.c
CC = gcc
